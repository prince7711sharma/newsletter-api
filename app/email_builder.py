...
<head>
  ...
  <title>Your Weekly Newsletter – R.S Education Solution</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:32px 40px 0;">
              ...
              <p style="margin:10px 0 0;color:#546e7a;font-size:14px;line-height:1.6;">
                Here's your personalized weekly update from <strong>R.S Education Solution</strong>.
          ...
          <tr>
            <td style="padding:28px 40px;text-align:center;">
              <p style="margin:0 0 12px;color:#1a73e8;font-weight:600;font-size:14px;">
                🌐 Please visit our website for more information related to college counselling.
              </p>
          ...
          <tr>
            <td style="background:#f8f9ff;border-top:1px solid #e8eaf6;
              ...
              <p style="margin:0;color:#90a4ae;font-size:11px;line-height:1.7;">
                You are receiving this email because you subscribed to <strong>R.S Education Solution</strong> newsletter.<br/>
                <a href="{unsubscribe_url}"
                   style="color:#1a73e8;text-decoration:none;font-weight:500;">
                  Unsubscribe anytime
                </a>
                &nbsp;·&nbsp;
                <span>R.S Education Solution, India</span>
              </p>
              <p style="margin:10px 0 0;color:#b0bec5;font-size:10px;">
                © 2025 R.S Education Solution. All rights reserved.
              </p>
            </td>
          </tr>
...
def get_email_subject(name: str) -> str:
    return f"📚 {name}, your weekly update from R.S Education Solution is here!"
